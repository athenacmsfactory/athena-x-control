...
export const ApiService = {
  ...
  deleteSite: (id) => fetch(`${API_BASE}/sites/${id}/delete`, { method: 'POST' }).then(res => res.json()),
  deleteFromVault: (id) => fetch(`${API_BASE}/sites/${id}/vault-delete`, { method: 'POST' }).then(res => res.json()),
